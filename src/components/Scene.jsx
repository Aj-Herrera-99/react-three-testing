    ...
    return (
        <>
            <Canvas ref={canvasRef} frameloop={isZooming ? 'demand' : 'always'} style={{ background: 'black' }}>
                ...
                <Html style={{ position: "absolute", left: '50%', transform: 'translateX(-50%)' }} position={[0, -3.2, 0]}>
                    <button onClick={startZoom} className="hover:border-b px-2 py-1 text-sm lg:text-xl text-white text-nowrap cursor-pointer hover:scale-[1.1] transition-transform ">
                        start your journey
                    </button>
                </Html>
            </Canvas>
